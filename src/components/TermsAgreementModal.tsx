      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
          ...
          >
            ...
            <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#FF007A]/15 rounded-full blur-[70px] pointer-events-none"></div>

            <div className="flex items-center justify-between pb-4 border-b border-border-main/60 mb-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-2xl bg-[#FF007A]/10 flex items-center justify-center border border-[#FF007A]/20 text-[#FF007A]">
            ...
            <div className="space-y-4 mb-6 text-sm text-text-secondary leading-relaxed">
              ...
              <div className="bg-input/80 rounded-2xl p-4 border border-border-main/70 space-y-3">
                <div className="flex items-start gap-2.5">
                  <Lock className="w-4 h-4 text-[#FF007A] shrink-0 mt-0.5" />
              ...
              <div className="space-y-3 pt-2">
                <label className="flex items-start gap-3 cursor-pointer group p-3 rounded-xl border border-border-main/60 bg-input/40 hover:bg-input transition-colors">
                  <div className="relative flex items-center mt-0.5">
                    ...
                    />
                    <div className="w-5 h-5 rounded-md border-2 border-border-main peer-checked:border-[#FF007A] peer-checked:bg-[#FF007A] transition-all flex items-center justify-center">
                  ...
                  <span className="text-xs font-medium text-text-main leading-normal select-none">
                    ...
                    <a
                      ...
                      className="text-[#FF007A] hover:underline inline-flex items-center gap-0.5 font-bold"
            ...
            <button
              ...
              className={`w-full py-3.5 rounded-xl text-sm font-bold transition-all flex items-center justify-center gap-2 ${
                agreeTerms && agreeJurisdiction
                  ? 'bg-[#FF007A] hover:bg-[#E6006F] text-white shadow-lg shadow-[#00A3FF]/25 cursor-pointer active:scale-[0.99]'
                  : 'bg-[#FF007A]/30 text-white/50 cursor-not-allowed'
              }`}
            >
